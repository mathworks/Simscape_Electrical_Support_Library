function branch_placement(model,data)
%
...
for ll = 1:nld
    ...
    h = add_block('network_components/branch',[model,'/branch_',nf,'_',nt,'_',num2str(numDuplicates(ll))]);

    hb = find_system(h,'FindAll','on','LookUnderMasks','all','RegExp','on','Name','pos_seq_branch');
